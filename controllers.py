...
class TradeController:
    ...
    def buy():
        """
        in order for the user to be able to buy stock the following must be satisfied:
        - user exists
        - stock exists
...
        once all of the above is satisfied the user amount is decremented and a new trade record is created to represent a buy.
        """
        try:
    ...
    def sell():
        """
        in order for the user to be able to sell stock the following must be satisfied:
        - user exists
        - stock exists
        - stock price is between upper and lower bound
        - the user holds stocks equal to or greater than the number of stocks he wants to sell
        once all of the above is satisfied the user amount is incremented and a new trade record is created with a negative total to represent a sale. 
        """
        try:
            body, user, stock = TradeController._validate_trade_constraints(
                request)
